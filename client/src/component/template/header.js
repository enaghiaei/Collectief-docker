     ...
     if (this.state.user_type == 4) {
         return (
             <div>
                 <div>
                     ...
                     <div id="node_user_type" className="header_items00 pt-2 pb-2 pr-2 pl-2" style={{ opacity: "0.8", right: "470px", top: "23px", "padding": "3px", "border-radius": "6px", "font-weight": "bold", "letter-spacing": "1px" }}>
                         {this.set_user_type()}
                     </div>
      ...
      <div>
          <div>
                      ...
                      <div id="node_user_type" className="header_items00 pt-2 pb-2 pr-2 pl-2" style={{ opacity: "0.8", right: "300px", top: "23px", "padding":"3px","border-radius":"6px","font-weight":"bold","letter-spacing":"1px"}}>
                  {this.set_user_type()}
              </div>
              <div className="header_items0" id="header_items0" style={{ right: "40px", top: "22px", color: "#fff", "padding": "3px", "border-radius": "6px", "letter-spacing": "1px", "width": "40px", "height": "40px", "border-radius": "20px" }}>
