...
import { faAdd, faMinus, faGear, faTemperature0, faPowerOff, faArrowRight, faArrowLeft, faInfo, faCircleInfo, faInfoCircle, faHome, faClock, faVolumeControlPhone, faWarning, faExchange, faList, faPlus, faUser, faLocation, faLocationDot, faCalculator } from '@fortawesome/free-solid-svg-icons';
    ...
    resizeCanvas() {
       ...
       //console.log(page_size);
        ...
        if (page_size.width > 1056) {
            ...
            $(".v_m").css("height", (0.3 * page_size.width));
