...
exports.save_ = function (schedule, res0) {
   ...
   //console.log(global.config)
    con.connect(function (err) {
        ...
        //console.log(result0);
        var val = [[schedule.title, 0, schedule.type]];
        var res = con.query("INSERT INTO collectief_location (cl_title,cl_user,cl_type) VALUES ?", [val], function (err, result, fields) {
           //console.log(res.sql);        
            //console.log(result); 
